export default {
  ...
  parameters: [
    ...
    { key: 'maxNursery', 
      ...
      unit: 'M', 
      group: 'Heap',
      slider: { min: 16, max: (vals, preset) => preset.maxHeap * 0.5, step: 8 },
    ...
    { key: 'maxJitCodeCache', 
      label: 'JIT code cache', 
      type: 'slider',
      unit: 'M',
      group: 'Code cache', 
      slider: { min: 16, max: 384, step: 8 },
      formatJvm: (v) => `-Xcodecachetotal<i>${v}</i>m` 
    },
    { key: 'maxJitDataCache', 
      label: 'JIT data cache', 
      type: 'slider',
      unit: 'M', 
      group: 'Code cache',
      slider: { min: 16, max: 256, step: 8 },
